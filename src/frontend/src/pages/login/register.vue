    ...
    <div class="right-section">
      <div class="register-form-container">
        ...
        <div class="header">
          ...
          <p class="subtitle">智能小助手 - 创建您的账户，开始智能对话之旅</p>
        </div>
    ...
    .header {
      ...
      .logo {
        ...
        .logo-text {
          ...
          box-shadow: 0 0 24px rgba(124, 58, 237, 0.3), 0 4px 12px rgba(0, 102, 255, 0.2);
        }
      }
    ...
    .register-form {
      ...
      .register-button {
        ...
        &:hover {
          ...
          box-shadow: 0 0 32px rgba(124, 58, 237, 0.35), 0 8px 25px rgba(0, 102, 255, 0.2);
        }
